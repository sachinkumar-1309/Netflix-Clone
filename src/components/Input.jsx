  ...
  return (
    <div className="relative">
      <input
        ...
        value={value}
        id={id}
        className={`block rounded px-6 pt-5 pb-3 w-full bg-none text-md text-white bg-[#131011] focus:appearance-none focus:outline-none focus:ring-0 peer ${className}`}
        placeholder="   "
        autoComplete="on"
      />
      <label
